...
## Executive summary
Using Autopsy 4.22.1 I examined the provided casper-rw images. This report records observations, artifacts found, and recommendations for preservation and further analysis. It avoids asserting exports[...] 
...
## Images & EXIF summary
- Photos were identified during analysis. An EXIF CSV export was not produced as part of this report. If desired, an EXIF export can be generated with the following fields: filename, DateTimeOriginal,[...]

## Evidence (screenshots)
- Search history evidence: ![Search History](./Screenshot%202026-06-29%20141928.png)
- Image metadata evidence: ![Image Metadata](./Screenshot%202026-06-29%20142333.png)
